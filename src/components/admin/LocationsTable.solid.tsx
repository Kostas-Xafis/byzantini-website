...
const LocationsInputs = (location?: Locations): Record<keyof Locations, InputProps> => {
	return {
		...
		number: { name: "number", label: "Αριθμός", type: "number", iconClasses: "fa-solid fa-hashtag" },
